...
int main(){ //Main function
	float radiusOfCircle, sideOfSquare, lenghtOfRectangle, widthOfRectangle; //Float declaration
	radiusOfCircle=8; 
	sideOfSquare= 7;
	lenghtOfRectangle= 9;
	widthOfRectangle= 4;
	...
	printf("Area of Rectangle= %.1f\n", lenghtOfRectangle*widthOfRectangle); //For printing the value of Area of Rectangle
	printf("Perimeter of Rectangle= %.1f\n", 2*lenghtOfRectangle*widthOfRectangle); //For printing the value of Perimeter of Rectangle
